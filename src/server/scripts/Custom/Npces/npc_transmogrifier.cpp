...
#include "Config.h"
#include "Language.h"
#include "../System/system_transmogrification.h"
...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
		...
		player->SEND_GOSSIP_MENU("|TInterface/ICONS/INV_Misc_Book_11:30:30:-18:0|tHow transmogrification works", creature->GetGUID());
        return true;
    }
        ...
        case EQUIPMENT_SLOT_END+4: // Presets menu
            {
                ...
                player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, "|TInterface/Glues/Common/Glue-LeftArrow-Button-Up:30:30:-18:0|tBack..", EQUIPMENT_SLOT_END+1, 0);
        ...
        case EQUIPMENT_SLOT_END+6: // view preset
            {
                ...
                player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, "|TInterface/Glues/Common/Glue-LeftArrow-Button-Up:30:30:-18:0|tBack..", EQUIPMENT_SLOT_END+4, 0);
                player->SEND_GOSSIP_MENU(DEFAULT_GOSSIP_MESSAGE, creature->GetGUID());
            } break;
