...
#define NEXT_PAGE               "|TInterface/Glues/Common/Glue-RightArrow-Button-Up:30:30:-18:0|tNext.."
#define PREV_PAGE               "|TInterface/Glues/Common/Glue-LeftArrow-Button-Up:30:30:-18:0|tBack.."
#define MAIN_MENU               "|TInterface/Glues/Common/Glue-LeftArrow-Button-Up:30:30:-18:0|tBack.."
...
namespace
{
	...
	void ActionTeleport(Player * const player, Creature * const creature, const uint32 &id)
	{
		...
		if (player->getLevel() < dest.m_level && !player->IsGameMaster())
		{
			...
			ChatHandler(player->GetSession()).PSendSysMessage(msg.c_str(), player->GetGUID());
			return;
		}
...
public:
	...
	bool OnGossipHello(Player *player, Creature *creature)
	{
		...
		if(player->IsInCombat())
		{
			...
			ChatHandler(player->GetSession()).PSendSysMessage("You are in combat. Come back later", player->GetGUID());
			return true;
		}
