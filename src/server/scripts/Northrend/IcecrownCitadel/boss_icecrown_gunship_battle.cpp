    ...
    public:
        ...
        struct npc_gunship_mageAI : public gunship_npc_AI
        {
            npc_gunship_mageAI(Creature* creature) : gunship_npc_AI(creature)
			{
				...
				me->ApplySpellImmune(0, IMMUNITY_STATE, SPELL_AURA_MECHANIC_IMMUNITY_MASK, true);
				me->ApplySpellImmune(0, IMMUNITY_STATE, MECHANIC_GRIP, true);
				...
				me->ApplySpellImmune(0, IMMUNITY_STATE, SPELL_AURA_STATE_IMMUNITY, true);
				me->ApplySpellImmune(0, IMMUNITY_STATE, SPELL_AURA_EFFECT_IMMUNITY, true);
				me->ApplySpellImmune(0, IMMUNITY_STATE, SPELL_AURA_MOD_CASTING_SPEED_NOT_STACK, true);
				me->ApplySpellImmune(0, IMMUNITY_STATE, SPELL_AURA_MOD_STAT, true);
				me->ApplySpellImmune(0, IMMUNITY_STATE, SPELL_AURA_MOD_PERCENT_STAT, true);
				me->ApplySpellImmune(0, IMMUNITY_STATE, SPELL_AURA_CLONE_CASTER, true);
				me->ApplySpellImmune(0, IMMUNITY_STATE, SPELL_DEATH_GRIP, true);
			}
