...
void World::LoadConfigSettings(bool reload)
{
	...
	//Script For Disabling Arena
	m_bool_configs[CONFIG_ARENA_2v2_TEAM_ENABLE] 					 = sConfigMgr->GetBoolDefault("Arena.2v2.Team", true);
	m_bool_configs[CONFIG_ARENA_3v3_TEAM_ENABLE] 					 = sConfigMgr->GetBoolDefault("Arena.3v3.Team", true);
	m_bool_configs[CONFIG_ARENA_5v5_TEAM_ENABLE] 					 = sConfigMgr->GetBoolDefault("Arena.5v5.Team", true);
	m_int_configs[CONFIG_ARENA_START_TIME]							 = sConfigMgr->GetIntDefault("Arena.StartTime", 23);
	m_int_configs[CONFIG_ARENA_END_TIME]							 = sConfigMgr->GetIntDefault("Arena.EndTime", 10);
	// Script For Disabling Arena

	//Script for Online Point
	m_int_configs[CONFIG_ONLINE_POINT_TIME] = sConfigMgr->GetIntDefault("Online.Point.Time", 600); // In Secound
	m_int_configs[CONFIG_ONLINE_POINT_VALUE] = sConfigMgr->GetIntDefault("Online.Point.Value", 2);
	//Script for Online Point

	//Script for BG end reward
	m_int_configs[CONFIG_BG_END_REWARD_WINNER_WS] = sConfigMgr->GetIntDefault("BG.End.Reward.Winner.WS", 1);
	m_int_configs[CONFIG_BG_END_REWARD_WINNER_AB] = sConfigMgr->GetIntDefault("BG.End.Reward.Winner.AB", 1);
	m_int_configs[CONFIG_BG_END_REWARD_WINNER_AV] = sConfigMgr->GetIntDefault("BG.End.Reward.Winner.AV", 1);
	m_int_configs[CONFIG_BG_END_REWARD_WINNER_IC] = sConfigMgr->GetIntDefault("BG.End.Reward.Winner.IC", 1);
	m_int_configs[CONFIG_BG_END_REWARD_WINNER_SA] = sConfigMgr->GetIntDefault("BG.End.Reward.Winner.SA", 1);
	m_int_configs[CONFIG_BG_END_REWARD_WINNER_ES] = sConfigMgr->GetIntDefault("BG.End.Reward.Winner.ES", 1);
	m_int_configs[CONFIG_BG_END_REWARD_LOOSER_WS] = sConfigMgr->GetIntDefault("BG.End.Reward.Looser.WS", 1);
	m_int_configs[CONFIG_BG_END_REWARD_LOOSER_AB] = sConfigMgr->GetIntDefault("BG.End.Reward.Looser.AB", 1);
	m_int_configs[CONFIG_BG_END_REWARD_LOOSER_AV] = sConfigMgr->GetIntDefault("BG.End.Reward.Looser.AV", 1);
	m_int_configs[CONFIG_BG_END_REWARD_LOOSER_IC] = sConfigMgr->GetIntDefault("BG.End.Reward.Looser.IC", 1);
	m_int_configs[CONFIG_BG_END_REWARD_LOOSER_SA] = sConfigMgr->GetIntDefault("BG.End.Reward.Looser.SA", 1);
	m_int_configs[CONFIG_BG_END_REWARD_LOOSER_ES] = sConfigMgr->GetIntDefault("BG.End.Reward.Looser.ES", 1);

	m_int_configs[CONFIG_VIP1_BG_END_REWARD_WINNER_WS] = sConfigMgr->GetIntDefault("VIP1.BG.End.Reward.Winner.WS", 1);
	m_int_configs[CONFIG_VIP1_BG_END_REWARD_WINNER_AB] = sConfigMgr->GetIntDefault("VIP1.BG.End.Reward.Winner.AB", 1);
	m_int_configs[CONFIG_VIP1_BG_END_REWARD_WINNER_AV] = sConfigMgr->GetIntDefault("VIP1.BG.End.Reward.Winner.AV", 1);
	m_int_configs[CONFIG_VIP1_BG_END_REWARD_WINNER_IC] = sConfigMgr->GetIntDefault("VIP1.BG.End.Reward.Winner.IC", 1);
	m_int_configs[CONFIG_VIP1_BG_END_REWARD_WINNER_SA] = sConfigMgr->GetIntDefault("VIP1.BG.End.Reward.Winner.SA", 1);
	m_int_configs[CONFIG_VIP1_BG_END_REWARD_WINNER_ES] = sConfigMgr->GetIntDefault("VIP1.BG.End.Reward.Winner.ES", 1);
	m_int_configs[CONFIG_VIP1_BG_END_REWARD_LOOSER_WS] = sConfigMgr->GetIntDefault("VIP1.BG.End.Reward.Looser.WS", 1);
	m_int_configs[CONFIG_VIP1_BG_END_REWARD_LOOSER_AB] = sConfigMgr->GetIntDefault("VIP1.BG.End.Reward.Looser.AB", 1);
	m_int_configs[CONFIG_VIP1_BG_END_REWARD_LOOSER_AV] = sConfigMgr->GetIntDefault("VIP1.BG.End.Reward.Looser.AV", 1);
	m_int_configs[CONFIG_VIP1_BG_END_REWARD_LOOSER_IC] = sConfigMgr->GetIntDefault("VIP1.BG.End.Reward.Looser.IC", 1);
	m_int_configs[CONFIG_VIP1_BG_END_REWARD_LOOSER_SA] = sConfigMgr->GetIntDefault("VIP1.BG.End.Reward.Looser.SA", 1);
	m_int_configs[CONFIG_VIP1_BG_END_REWARD_LOOSER_ES] = sConfigMgr->GetIntDefault("VIP1.BG.End.Reward.Looser.ES", 1);

	m_int_configs[CONFIG_VIP2_BG_END_REWARD_WINNER_WS] = sConfigMgr->GetIntDefault("VIP2.BG.End.Reward.Winner.WS", 1);
	m_int_configs[CONFIG_VIP2_BG_END_REWARD_WINNER_AB] = sConfigMgr->GetIntDefault("VIP2.BG.End.Reward.Winner.AB", 1);
	m_int_configs[CONFIG_VIP2_BG_END_REWARD_WINNER_AV] = sConfigMgr->GetIntDefault("VIP2.BG.End.Reward.Winner.AV", 1);
	m_int_configs[CONFIG_VIP2_BG_END_REWARD_WINNER_IC] = sConfigMgr->GetIntDefault("VIP2.BG.End.Reward.Winner.IC", 1);
	m_int_configs[CONFIG_VIP2_BG_END_REWARD_WINNER_SA] = sConfigMgr->GetIntDefault("VIP2.BG.End.Reward.Winner.SA", 1);
	m_int_configs[CONFIG_VIP2_BG_END_REWARD_WINNER_ES] = sConfigMgr->GetIntDefault("VIP2.BG.End.Reward.Winner.ES", 1);
	m_int_configs[CONFIG_VIP2_BG_END_REWARD_LOOSER_WS] = sConfigMgr->GetIntDefault("VIP2.BG.End.Reward.Looser.WS", 1);
	m_int_configs[CONFIG_VIP2_BG_END_REWARD_LOOSER_AB] = sConfigMgr->GetIntDefault("VIP2.BG.End.Reward.Looser.AB", 1);
	m_int_configs[CONFIG_VIP2_BG_END_REWARD_LOOSER_AV] = sConfigMgr->GetIntDefault("VIP2.BG.End.Reward.Looser.AV", 1);
	m_int_configs[CONFIG_VIP2_BG_END_REWARD_LOOSER_IC] = sConfigMgr->GetIntDefault("VIP2.BG.End.Reward.Looser.IC", 1);
	m_int_configs[CONFIG_VIP2_BG_END_REWARD_LOOSER_SA] = sConfigMgr->GetIntDefault("VIP2.BG.End.Reward.Looser.SA", 1);
	m_int_configs[CONFIG_VIP2_BG_END_REWARD_LOOSER_ES] = sConfigMgr->GetIntDefault("VIP2.BG.End.Reward.Looser.ES", 1);

	m_int_configs[CONFIG_VIP3_BG_END_REWARD_WINNER_WS] = sConfigMgr->GetIntDefault("VIP3.BG.End.Reward.Winner.WS", 1);
	m_int_configs[CONFIG_VIP3_BG_END_REWARD_WINNER_AB] = sConfigMgr->GetIntDefault("VIP3.BG.End.Reward.Winner.AB", 1);
	m_int_configs[CONFIG_VIP3_BG_END_REWARD_WINNER_AV] = sConfigMgr->GetIntDefault("VIP3.BG.End.Reward.Winner.AV", 1);
	m_int_configs[CONFIG_VIP3_BG_END_REWARD_WINNER_IC] = sConfigMgr->GetIntDefault("VIP3.BG.End.Reward.Winner.IC", 1);
	m_int_configs[CONFIG_VIP3_BG_END_REWARD_WINNER_SA] = sConfigMgr->GetIntDefault("VIP3.BG.End.Reward.Winner.SA", 1);
	m_int_configs[CONFIG_VIP3_BG_END_REWARD_WINNER_ES] = sConfigMgr->GetIntDefault("VIP3.BG.End.Reward.Winner.ES", 1);
	m_int_configs[CONFIG_VIP3_BG_END_REWARD_LOOSER_WS] = sConfigMgr->GetIntDefault("VIP3.BG.End.Reward.Looser.WS", 1);
	m_int_configs[CONFIG_VIP3_BG_END_REWARD_LOOSER_AB] = sConfigMgr->GetIntDefault("VIP3.BG.End.Reward.Looser.AB", 1);
	m_int_configs[CONFIG_VIP3_BG_END_REWARD_LOOSER_AV] = sConfigMgr->GetIntDefault("VIP3.BG.End.Reward.Looser.AV", 1);
	m_int_configs[CONFIG_VIP3_BG_END_REWARD_LOOSER_IC] = sConfigMgr->GetIntDefault("VIP3.BG.End.Reward.Looser.IC", 1);
	m_int_configs[CONFIG_VIP3_BG_END_REWARD_LOOSER_SA] = sConfigMgr->GetIntDefault("VIP3.BG.End.Reward.Looser.SA", 1);
	m_int_configs[CONFIG_VIP3_BG_END_REWARD_LOOSER_ES] = sConfigMgr->GetIntDefault("VIP3.BG.End.Reward.Looser.ES", 1);
	//Script for BG end reward
    ...
    // Script For Arena Reward Item
    m_bool_configs[CONFIG_FOR_ARENA_ENABLE] = sConfigMgr->GetBoolDefault("Arena.Enable", false);
    m_int_configs[CONFIG_FOR_ARENA_ITEM_ID] = sConfigMgr->GetIntDefault("Arena.Item.id", 1);
    m_int_configs[CONFIG_FOR_ARENA_COUNT_ID] = sConfigMgr->GetIntDefault("Arena.Item.Count", 1);
    // Script For Arena Reward Item

    // Script For Account Vips
    rate_values[VIP_RATE_HONOR] = sConfigMgr->GetFloatDefault("Vip.Rate.Honor", 1.0f);
    m_int_configs[VIP_TOKEN_DROP_COUNT] = sConfigMgr->GetIntDefault("Vip.Token.Drop.Count", 1);
    m_int_configs[VIP_RATE_DEFENSE] = sConfigMgr->GetIntDefault("Vip.Rate.Defense", 1);
    m_int_configs[VIP_RATE_WEAPON] = sConfigMgr->GetIntDefault("Vip.Rate.Weapon", 1);
    rate_values[VIP_RATE_EXPLORER] = sConfigMgr->GetFloatDefault("Vip.Rate.Explorer", 1.0f);
    rate_values[VIP_RATE_QUEST] = sConfigMgr->GetFloatDefault("Vip.Rate.Quest", 1.0f);
    rate_values[VIP_RATE_KILL_EXP] = sConfigMgr->GetFloatDefault("Vip.Rate.Exp", 1.0f);
    rate_values[VIP_RATE_REP] = sConfigMgr->GetFloatDefault("Vip.Rate.Rep", 1.0f);
    m_int_configs[VIP_RATE_CRAFTING] = sConfigMgr->GetIntDefault("Vip.Rate.Crafting", 1);
    m_int_configs[VIP_RATE_GATHERING] = sConfigMgr->GetIntDefault("Vip.Rate.Gathering", 1);
    // Script For Account Vips

    // Script For Global Channel
    m_bool_configs[CONFIG_FOR_GLOBAL_ENABLE] = sConfigMgr->GetBoolDefault("Global.Enable", false);
    // Script For Global Channel

    // Script For Global Channel
    m_bool_configs[CONFIG_FOR_GM_CHAT_ENABLE] = sConfigMgr->GetBoolDefault("GmChat.Enable", false);
    // Script For Global Channel

    // Script For Global Channel
    m_int_configs[CONFIG_FOR_FAKE_PLAYER_TEDAD] = sConfigMgr->GetIntDefault("FakePlayer.Tedad", 25);
    m_int_configs[CONFIG_FOR_FAKE_PLAYER_TAQSIM] = sConfigMgr->GetIntDefault("FakePlayer.Taqsim", 5);
    m_float_configs[CONFIG_FOR_FAKE_PLAYER_ZARIB] = sConfigMgr->GetFloatDefault("FakePlayer.Zarib", 1.0f);
    // Script For Global Channel

    // Script For Player Level
    m_int_configs[PLAYER_LEVEL_EVENT] = sConfigMgr->GetIntDefault("Player.Level.Event", 80);
    // Script For Player Level
...
void World::SetInitialWorldSettings()
{
	...
	TC_LOG_INFO("server.loading", "Loading Custom requirements...");
	sObjectMgr->LoadCustomRequirements();

	TC_LOG_INFO("server.loading", "Loading Custom reward...");
	sObjectMgr->LoadCustomReward();
    ...
    // Script For Global Channel
    m_timers[GLOBAL_TIMER_MESSAGE].SetInterval(30 * IN_MILLISECONDS);
    // Script For Global Channel

    // Script For External Mail
    m_timers[EXTERNAL_MAIL].SetInterval(60 * IN_MILLISECONDS);
    // Script For External Mail
...
void World::Update(uint32 diff)
{
    ...
    // Script For Global Channel
    if (m_timers[GLOBAL_TIMER_MESSAGE].Passed())
    {
        m_timers[GLOBAL_TIMER_MESSAGE].Reset();
        ...
        for (SessionMap::const_iterator itr = m_sessions.begin(); itr != m_sessions.end(); ++itr)
        {
            ...
            session->GetPlayer()->GLOBAL_TIME_MESSAGE = true;
            // Fix Raise Dead Death Knight
            session->GetPlayer()->RemoveSpellCooldown(46584, true);
            // Fix Raise Dead Death Knight
        }
    }
    // Script For Global Channel
    ...
    // Script For External Mail
    if (m_timers[EXTERNAL_MAIL].Passed())
    {
        WorldSession::SendExternalMails();
        m_timers[EXTERNAL_MAIL].Reset();
    }
    // Script For External Mail
