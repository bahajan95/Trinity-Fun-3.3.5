        ...
        if (isArena())
        {
            ...
            for (BattlegroundPlayerMap::const_iterator itr = GetPlayers().begin(); itr != GetPlayers().end(); ++itr)
                if (Player* player = ObjectAccessor::FindPlayer(itr->first))
                {
                    // BG Status packet
                    WorldPacket status;
					BattlegroundQueueTypeId bgQueueTypeId = sBattlegroundMgr->BGQueueTypeId(m_TypeID, GetArenaType(), player);
...
void Battleground::EndBattleground(uint32 winner)
{
	...
	BattlegroundQueueTypeId bgQueueTypeId = BattlegroundMgr::BGQueueTypeId(GetTypeID(), GetArenaType(), nullptr);
    ...
    for (BattlegroundPlayerMap::iterator itr = m_Players.begin(); itr != m_Players.end(); ++itr)
    {
		...
		if (team == winner)
		{
			...
			switch (player->GetSession()->GetVipLevel())
			{
				case 0:
				{
						  reward_ws = sWorld->getIntConfig(CONFIG_BG_END_REWARD_WINNER_WS);
						  reward_ab = sWorld->getIntConfig(CONFIG_BG_END_REWARD_WINNER_AB);
						  reward_av = sWorld->getIntConfig(CONFIG_BG_END_REWARD_WINNER_AV);
						  reward_ic = sWorld->getIntConfig(CONFIG_BG_END_REWARD_WINNER_IC);
						  reward_sa = sWorld->getIntConfig(CONFIG_BG_END_REWARD_WINNER_SA);
						  reward_es = sWorld->getIntConfig(CONFIG_BG_END_REWARD_WINNER_ES);
				}
				break;
				case 1:
				{
						  reward_ws = sWorld->getIntConfig(CONFIG_VIP1_BG_END_REWARD_WINNER_WS);
						  reward_ab = sWorld->getIntConfig(CONFIG_VIP1_BG_END_REWARD_WINNER_AB);
						  reward_av = sWorld->getIntConfig(CONFIG_VIP1_BG_END_REWARD_WINNER_AV);
						  reward_ic = sWorld->getIntConfig(CONFIG_VIP1_BG_END_REWARD_WINNER_IC);
						  reward_sa = sWorld->getIntConfig(CONFIG_VIP1_BG_END_REWARD_WINNER_SA);
						  reward_es = sWorld->getIntConfig(CONFIG_VIP1_BG_END_REWARD_WINNER_ES);
				}
				break;
				case 2:
				{
						  reward_ws = sWorld->getIntConfig(CONFIG_VIP2_BG_END_REWARD_WINNER_WS);
						  reward_ab = sWorld->getIntConfig(CONFIG_VIP2_BG_END_REWARD_WINNER_AB);
						  reward_av = sWorld->getIntConfig(CONFIG_VIP2_BG_END_REWARD_WINNER_AV);
						  reward_ic = sWorld->getIntConfig(CONFIG_VIP2_BG_END_REWARD_WINNER_IC);
						  reward_sa = sWorld->getIntConfig(CONFIG_VIP2_BG_END_REWARD_WINNER_SA);
						  reward_es = sWorld->getIntConfig(CONFIG_VIP2_BG_END_REWARD_WINNER_ES);
				}
				break;
				case 3:
				{
						  reward_ws = sWorld->getIntConfig(CONFIG_VIP3_BG_END_REWARD_WINNER_WS);
						  reward_ab = sWorld->getIntConfig(CONFIG_VIP3_BG_END_REWARD_WINNER_AB);
						  reward_av = sWorld->getIntConfig(CONFIG_VIP3_BG_END_REWARD_WINNER_AV);
						  reward_ic = sWorld->getIntConfig(CONFIG_VIP3_BG_END_REWARD_WINNER_IC);
						  reward_sa = sWorld->getIntConfig(CONFIG_VIP3_BG_END_REWARD_WINNER_SA);
						  reward_es = sWorld->getIntConfig(CONFIG_VIP3_BG_END_REWARD_WINNER_ES);
				}
				break;
			}
			...
			{
			case 3277:
				sM->AddPlayerMPs(player, reward_ws);
				break;
			case 3358:
				sM->AddPlayerMPs(player, reward_ab);
				break;
			case 2820:
				sM->AddPlayerMPs(player, reward_es);
				break;
			case 4710:
				sM->AddPlayerMPs(player, reward_ic);
				break;
			case 4384:
				sM->AddPlayerMPs(player, reward_sa);
				break;
			case 2795:
				sM->AddPlayerMPs(player, reward_av);
			default:
				break;
			}
		}
		else
		{
			...
			switch (player->GetSession()->GetVipLevel())
			{
				case 0:
				{
						  reward_ws = sWorld->getIntConfig(CONFIG_BG_END_REWARD_LOOSER_WS);
						  reward_ab = sWorld->getIntConfig(CONFIG_BG_END_REWARD_LOOSER_AB);
						  reward_av = sWorld->getIntConfig(CONFIG_BG_END_REWARD_LOOSER_AV);
						  reward_ic = sWorld->getIntConfig(CONFIG_BG_END_REWARD_LOOSER_IC);
						  reward_sa = sWorld->getIntConfig(CONFIG_BG_END_REWARD_LOOSER_SA);
						  reward_es = sWorld->getIntConfig(CONFIG_BG_END_REWARD_LOOSER_ES);
				}
				break;
				case 1:
				{
						  reward_ws = sWorld->getIntConfig(CONFIG_VIP1_BG_END_REWARD_LOOSER_WS);
						  reward_ab = sWorld->getIntConfig(CONFIG_VIP1_BG_END_REWARD_LOOSER_AB);
						  reward_av = sWorld->getIntConfig(CONFIG_VIP1_BG_END_REWARD_LOOSER_AV);
						  reward_ic = sWorld->getIntConfig(CONFIG_VIP1_BG_END_REWARD_LOOSER_IC);
						  reward_sa = sWorld->getIntConfig(CONFIG_VIP1_BG_END_REWARD_LOOSER_SA);
						  reward_es = sWorld->getIntConfig(CONFIG_VIP1_BG_END_REWARD_LOOSER_ES);
				}
				break;
				case 2:
				{
						  reward_ws = sWorld->getIntConfig(CONFIG_VIP2_BG_END_REWARD_LOOSER_WS);
						  reward_ab = sWorld->getIntConfig(CONFIG_VIP2_BG_END_REWARD_LOOSER_AB);
						  reward_av = sWorld->getIntConfig(CONFIG_VIP2_BG_END_REWARD_LOOSER_AV);
						  reward_ic = sWorld->getIntConfig(CONFIG_VIP2_BG_END_REWARD_LOOSER_IC);
						  reward_sa = sWorld->getIntConfig(CONFIG_VIP2_BG_END_REWARD_LOOSER_SA);
						  reward_es = sWorld->getIntConfig(CONFIG_VIP2_BG_END_REWARD_LOOSER_ES);
				}
				break;
				case 3:
				{
						  reward_ws = sWorld->getIntConfig(CONFIG_VIP3_BG_END_REWARD_LOOSER_WS);
						  reward_ab = sWorld->getIntConfig(CONFIG_VIP3_BG_END_REWARD_LOOSER_AB);
						  reward_av = sWorld->getIntConfig(CONFIG_VIP3_BG_END_REWARD_LOOSER_AV);
						  reward_ic = sWorld->getIntConfig(CONFIG_VIP3_BG_END_REWARD_LOOSER_IC);
						  reward_sa = sWorld->getIntConfig(CONFIG_VIP3_BG_END_REWARD_LOOSER_SA);
						  reward_es = sWorld->getIntConfig(CONFIG_VIP3_BG_END_REWARD_LOOSER_ES);
				}
				break;
			}
...
void Battleground::RemovePlayerAtLeave(uint64 guid, bool Transport, bool SendPacket)
{
    ...
    if (participant) // if the player was a match participant, remove auras, calc rating, update queue
    {
		...
		BattlegroundQueueTypeId bgQueueTypeId = BattlegroundMgr::BGQueueTypeId(GetTypeID(), GetArenaType(), player);
        if (player)
        {
