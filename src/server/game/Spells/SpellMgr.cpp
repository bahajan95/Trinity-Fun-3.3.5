...
bool SpellArea::IsFitToRequirements(Player const* player, uint32 newZone, uint32 newArea) const
{
    ...
    switch (spellId)
    {
        ...
        {
            Player* PPlayer = ObjectAccessor::FindPlayer(player->GetGUID());
            // Script For Account Vips
            if (!player || PPlayer->GetReceiveMessage(CHECK_VIP_PLAYER_ACTIVE) == true)
                return false;
            // Script For Account Vips
...
void SpellMgr::LoadSpellInfoCorrections()
{
    ...
    for (uint32 i = 0; i < GetSpellInfoStoreSize(); ++i)
    {
        ...
        switch (spellInfo->Id)
        {
            // Fix Hunter Flare Speed Apply
            case 1543:
                spellInfo->Speed = 100;
                break;
            // Fix Hunter Flare Speed Apply
            // Fix Talent Warlock Spell Improved Succubuss Duration Talent
            case 18754:
            ...
            case 18756:
                ...
                break;
            // Fix Talent Warlock Spell Improved Succubuss Duration Talent
            // Fix Warlock Pet Felhunter Spell Lock Interrupt
            case 24259:
                spellInfo->Speed = 80;
                break;
            // Fix Warlock Pet Felhunter Spell Lock Interrupt
            // Fix Death Knight Talent Magic Suppression
            case 49224:
            ...
            case 49611:
                ...
                break;
            // Fix Death Knight Talent Magic Suppression
            // Fix Rogue Slice and Dice Combat
            case 5171:
        ...
        switch (spellInfo->SpellFamilyName)
        {
            // Fix Silencing Shot AND Scatter Shot Instant Apply
            case SPELLFAMILY_HUNTER:
