...
enum RBACPermissions
{
	...
	RBAC_PERM_COMMAND_CHEAK_CHEAK                          	 = 2000,
	RBAC_PERM_COMMAND_CHEAK_KILL                        	 = 2001,
	RBAC_PERM_COMMAND_CHEAK_GLOBAL                        	 = 2002, 
	RBAC_PERM_COMMAND_CHEAK_GM_CHAT                        	 = 2003,
	RBAC_PERM_COMMAND_DUEL_COMMAND                        	 = 2004,
	RBAC_PERM_COMMAND_WORLD_COMMAND                       	 = 2005,
	RBAC_PERM_COMMAND_NEWS_COMMAND                           = 2006,
	RBAC_PERM_COMMAND_MEGAPOINT_COMMAND						 = 2007,
	RBAC_PERM_COMMAND_MEGAPOINT_ADD_COMMAND					 = 2008,
	RBAC_PERM_COMMAND_MEGAPOINT_REMOVE_COMMAND				 = 2009,
	RBAC_PERM_COMMAND_GOMOVE								 = 2010,
	RBAC_PERM_COMMAND_RELOAD_CUSTOM_REQUIREMENTS             = 2011,
	RBAC_PERM_COMMAND_RELOAD_CUSTOM_REWARD                   = 2012,
	RBAC_PERM_COMMAND_RELOAD_ITEM_TEMPLATE					 = 2013,
	RBAC_PERM_COMMAND_GUILD_LINFO                            = 2014,
    RBAC_PERM_COMMAND_GUILD_SET_LEVEL                        = 2015,
    RBAC_PERM_COMMAND_GUILD_GIVE_XP                          = 2016,
	RBAC_PERM_COMMAND_MALL_COMMAND							 = 2017,
	RBAC_PERM_COMMAND_duels_COMMAND							 = 2018,
	RBAC_PERM_COMMAND_TRINITY_ADD						     = 2019,
	RBAC_PERM_COMMAND_TRINITY						         = 2020,
	RBAC_PERM_COMMAND_pvps_COMMAND                           = 2021,
	RBAC_PERM_COMMAND_SPECTATE_COMMAND                       = 2022,
	RBAC_PERM_COMMAND_PLAYER_COMMAND                         = 2023,
	RBAC_PERM_COMMAND_VIEW_COMMAND                           = 2024,
	RBAC_PERM_COMMAND_RESET_COMMAND                          = 2025,
	RBAC_PERM_COMMAND_LEAVE_COMMAND                          = 2026,
	RBAC_PERM_COMMAND_RELOAD_CHAT_FILTER                     = 2027,
    RBAC_PERM_MAX 
};
