...
//Script For Requirements
#define MAX_CUSTOM_REQUIREMENTS_NEEDITEM 9
#define MAX_CUSTOM_REQUIREMENTS_COUNTITEM 9
struct CustomRequirements
{
	uint8 requiredlevel;
	uint32 megapoints;
	uint8 viplevel;
	...
	uint32 classMask;
	uint16 duelrating;
	uint16 arena2v2rating;
	uint16 arena3v3rating;
	uint16 arena5v5rating;
	uint32 needitem[MAX_CUSTOM_REQUIREMENTS_NEEDITEM];
	uint8 itemcount[MAX_CUSTOM_REQUIREMENTS_COUNTITEM];
	uint32 rewardid;
};
typedef std::unordered_map<uint32, CustomRequirements> CustomRequirementsContainer;
//Script for Requirements


//Script For Reward
#define MAX_CUSTOM_REWARD_NEEDITEM 9
#define MAX_CUSTOM_REWARD_COUNTITEM 9
struct CustomReward
{
	uint8 level;
	uint32 megapoints;
	...
	uint32 votepoints;
	uint32 onlinepoints;
	uint32 needitem[MAX_CUSTOM_REWARD_NEEDITEM];
	uint8 itemcount[MAX_CUSTOM_REWARD_COUNTITEM];
};
typedef std::unordered_map<uint32, CustomReward> CustomRewardContainer;
//Script for Reward
...
class ObjectMgr
{
    ...
    public:
        ...
        */
		...
		void LoadCustomRequirements();
		//Script For Custom Requirements

		//Script For Custom Reward
		void LoadCustomReward();
		//Script For Custom Reward
		...
		//Script For Custom Requirements
		const CustomRequirementsContainer* GetCustomRequirementsMap() const { return &_customRequirementsStore; }
		//Script For Custom Requirements

		//Script For Custom Reward
		const CustomRewardContainer* GetCustomRewardMap() const { return &_customRewardStore; }
		//Script For Custom Rewarf
    ...
    private:
		...
		//Script For Custom Requirements
		CustomRequirementsContainer _customRequirementsStore;
		//Script For Custom Requirements

		//Script For Custom Reward
		CustomRewardContainer _customRewardStore;
		//Script For Custom Reward
