...
enum GetReceiveMessageEnum
{
    CHECK_GLOBAL_MESSAGE_SEE  = 0,
    CHECK_VIP_PLAYER_ACTIVE   = 1,
    CHECK_KILL_PLAYER_MESSAGE = 2,
    CHECK_GM_CHECK_CHAT       = 3
};
// Script Get Receive Message
...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        // Script Get Receive Message
        bool GetReceiveMessage(int Message);
        bool GLOBAL_MESSAGE_SEE;
        bool GLOBAL_TIME_MESSAGE;
        bool VIP_PLAYER_ACTIVE;
        bool GM_CHECK_CHAT;
        bool KILL_PLAYER_MESSAGE;
        // Script Get Receive Message
